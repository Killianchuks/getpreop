        ...
        <header className="site-header">
          <div className="site-header-content">
            ...
            <nav className="site-header-nav">
              <Link href="/#work" className="hover:text-teal-800 transition">Work</Link>
              <Link href="/#collaborate" className="hover:text-teal-800 transition">Collaborate</Link>
              <Link href="/about" className="hover:text-teal-800 transition">About</Link>
              <Link href="/contact" className="hover:text-teal-800 transition">Contact</Link>
              <Link href="/what-we-offer" className="hover:text-teal-800 transition">GetPreOp Platform</Link>
            </nav>
